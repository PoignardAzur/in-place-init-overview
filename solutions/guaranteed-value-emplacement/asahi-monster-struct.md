...
```rust
// The context is adapted somewhat from
// <https://github.com/AsahiLinux/linux/blob/asahi/drivers/gpu/drm/asahi/initdata.rs#L236-L478>
// Grep for "// MODIFIED" to see places where the code is different.
self.alloc.private.new_init(create_pin_init! {
    let cfg = &self.cfg;
    let dyncfg = &self.dyncfg;

    let pin mut raw = raw::HwDataA::ver {
        ...
        // MODIFIED
        t81xx_data: unwrap_pin_init!(Self::t81xx_data(cfg, dyncfg)),
        // MODIFIED
        #[ver(V >= V13_0B4)]
        unk_e10_0: {
        ...
        unk_3644: 0,
        // MODIFIED
        hws1: unwrap_pin_init!(Self::hw_shared1(cfg)),
        hws2: unwrap_pin_init!(Self::hw_shared2(cfg, dyncfg)),
        hws3: unwrap_pin_init!(Self::hw_shared3(cfg)),
        unk_3ce8: 1,
        ..Zeroable::zeroed()
    };
